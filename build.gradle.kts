    ...
    publications {
        create<MavenPublication>("publication") {
            ...
            pom {
                ...
                url.set("https://github.com/Kotatsu-RTM/ModelIO")
                ...
                scm {
                    connection.set("scm:git:git://github.com/Kotatsu-RTM/ModelIO.git")
                    developerConnection.set("scm:git:ssh://github.com/Kotatsu-RTM/ModelIO.git")
                    url.set("https://github.com/Kotatsu-RTM/ModelIO")
                }
            }
        }
